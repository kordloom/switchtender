...
const NAV_ICONS = {
	...
	changes: '<path d="M4 7h9"/><path d="M4 12h16"/><path d="M4 17h6"/><circle cx="18" cy="7" r="2"/>',
...
const EXPORT_PAGES = ["runs", "fleet", "drift", "estate", "changes", "tasks", "compare", "workers", "schedules", "jobtemplates",
