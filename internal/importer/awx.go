...
// FromAWX maps an awx export document into a Plan of Yardmaster objects with cross-references wired
...
// Yardmaster survey fields, warning on any inexact type mapping.
