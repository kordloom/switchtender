...
func TestAskFleet(t *testing.T) {
	...
	off.ServeHTTP(rec, httptest.NewRequest(http.MethodPost, "/ai/ask",
	...
	rec = httptest.NewRecorder()
	handler.ServeHTTP(rec, httptest.NewRequest(http.MethodPost, "/ai/ask",
	...
	rec = httptest.NewRecorder()
	broken.ServeHTTP(rec, httptest.NewRequest(http.MethodPost, "/ai/ask",
