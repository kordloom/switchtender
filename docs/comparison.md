...
2026-08-10, for AWX 24.6.1, Ansible Automation Platform 2.7, Semaphore 2.19.12, Ascender 25.4.0,
and Rundeck 6.0.1. Release state re-verified 2026-09-06: AWX is still 24.6.1 and Semaphore is at
2.19.12, whose releases since 2.19.12 are bugfix-only and change no row. All of these ship, and a
