...
- External secrets through HashiCorp Vault (static and dynamic), AWS Secrets Manager, Google Secret Manager, and Azure Key Vault, plus any store through a command.
